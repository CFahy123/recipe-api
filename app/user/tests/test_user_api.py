...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Test creating a user that aleady exists"""
        payload = {
            'email':'JasonTatum@nba.com',
            'password': 'lucky',
        }
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email="test@test.com", password="test1234pass")
    ...
    def test_create_token_no_user(self):
        """test that a non user cannot create a token"""
        payload = {'email':'nonuser@test.com', 'password': 'nouser'}
